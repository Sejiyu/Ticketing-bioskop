...
public class Register extends javax.swing.JFrame {
    ...
    public Register() {
        ...
        fieldEmail = jTextField4;
        fieldUsername = jTextField3;
        fieldPassword = jTextField2;
        fieldPhone = jTextField1;
        fieldCode = jTextField5;
        comboRole = jComboBox1;
        btnRegister = jButton1;
        ...
        comboRole.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                fieldCode.setVisible("ADMIN".equals(selectedRole));
            }
        });

        
        btnRegister.addActionListener(e -> prosesRegistrasi());
    }
    ...
    private void prosesRegistrasi() {
        ...
        for (Pengguna user : dataPengguna) {
        ...
        Pengguna userBaru;
        if (role.equals("PENONTON")) {
            userBaru = new Penonton(generateId(), username, email, password, phone);
        } else {
            userBaru = new Admin(generateId(), username, email, password, "NIP123"); 
        }
        
        dataPengguna.add(userBaru);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "WATCHER", "ADMIN" }));
